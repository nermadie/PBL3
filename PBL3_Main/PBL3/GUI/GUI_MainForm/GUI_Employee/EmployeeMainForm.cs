...
namespace PBL3.GUI.GUI_MainForm.GUI_Employee
{
    public partial class EmployeeMainForm : Form
    {
        ...
        private EMF_CheckCode checkCode;
        private EMF_PrintTicket printTicket;
        ...
        public EmployeeMainForm(string idEmployee)
        {
            ...
            buttonPrintTicket.Enabled = false;
            home = new EMF_Home();
            addUserControl(home);
        ...
        private void openPayment(ShowTime showtime, List<string> seatsPurchased, DataGridViewRowCollection dataGridViewRows, int ticketPrice, int pdPrice, int totalPrice)
        {
            ...
            payment = new EMF_Payment(showtime, seatsPurchased, dataGridViewRows, ticketPrice, pdPrice, totalPrice);
        ...
        {
            buttonCheckCode.Checked = false;
            buttonPrintTicket.Checked = false;
            buttonPayment.Checked = false;
        ...
        {
            uncheckAnotherButton();
            buttonCheckCode.Checked = true;
            checkCode = new EMF_CheckCode(currentEm);
            addUserControl(checkCode);
        }

        private void buttonPrintTicket_Click(object sender, EventArgs e)
        {
            uncheckAnotherButton();
            buttonPrintTicket.Checked = true;
            printTicket = new EMF_PrintTicket();
            addUserControl(printTicket);
            buttonPrintTicket.Enabled = true;
            //buttonPrintTicket.Checked = true;
        }
    }
}
