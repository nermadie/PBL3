...
{
    public partial class EMF_Showtimes : UserControl
    {
        ...
        private void ImportDatatoPanelDetail(string idMovie)
        {
            ...
            Movie temp = BLL_QLRapchieuphim.Instance.getMoviebyIdMovie(idMovie);
            guna2PanelDetail.Enabled = true;
            guna2PictureBoxPoster.Enabled = true;
            guna2PictureBoxPoster.Image = BLL_QLRapchieuphim.Instance.getImagebyIdMovie(idMovie);
        ...
        private void loadDataintoFlowLayoutPanel(DateTime time, string text = "", bool isSearching = false)
        {
            ...
            flowLayoutPanelListST.Controls.AddRange(BLL_QLRapchieuphim.Instance.getListItem(time, ImportDatatoPanelDetail, buyTicketbyShowTime_Tickets, text));
