...
{
    public partial class CMF_History : UserControl
    {
        private Customer currentCus;
        public CMF_History(string cus)
        {
            InitializeComponent();
            this.currentCus = BLL_QLRapchieuphim.Instance.getCustomerbyIDCus(cus);
        }
        private void CMF_History_Load(object sender, EventArgs e)
        {
            //Load CBBItem
        ...
        private void guna2ComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                textBoxCode.ForeColor = Color.LightSeaGreen;
