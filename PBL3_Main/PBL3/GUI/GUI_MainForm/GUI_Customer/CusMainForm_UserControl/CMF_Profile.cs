...
namespace PBL3.GUI.GUI_MainForm.GUI_Customer.CusMainForm_UserControl
{
    public partial class CMF_Profile : UserControl
    {
        ...
        private string currentUserAva = String.Empty;
        ...
        private void buttonGetImage_Click(object sender, EventArgs e)
        {
            ...
            {
                pictureBoxUser.Image = BLL_QLRapchieuphim.Instance.getImagebyPath(openFileDialog.FileName);
                currentUserAva = openFileDialog.FileName;
            }
        }
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                BLL_QLRapchieuphim.Instance.updateCustomer(customer);
                BLL_QLRapchieuphim.Instance.updateCustomer(customer);
                if (currentUserAva != String.Empty)
                {
                    BLL_QLRapchieuphim.Instance.delImagebyIdPerson(currentCustomer.IdPerson);
                    File.Copy(currentUserAva, @"..\..\Image\Picture\PicturePerson\" + currentCustomer.IdPerson + Path.GetExtension(currentUserAva));
