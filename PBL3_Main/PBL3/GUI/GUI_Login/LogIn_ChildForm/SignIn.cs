...
namespace PBL3.GUI.GUI_Login.LogIn_ChildForm
{
    public partial class SignIn : UserControl
    {
        ...
        public delegate void Del_String(string username);
        public Del_String hideLoginForm { get; set; }
        ...
        private void buttonSignIn_Click(object sender, EventArgs e)
        {
            ...
            checkLoading = true;
            if (BLL_Login.Instance.checkUsername(textBoxUser.Text))
            {
                if (BLL_Login.Instance.checkAccount(textBoxUser.Text, textBoxPass.Text))
                {
                    hideLoginForm(textBoxUser.Text);
                    //In ra thong bao
