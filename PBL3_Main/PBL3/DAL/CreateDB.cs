...
namespace PBL3.DAL
{
    public class CreateDB : DropCreateDatabaseIfModelChanges<QLRapChieuPhim>
    {
        protected override void Seed(QLRapChieuPhim context)
        {
            ...
            {
                new Movie{IdMovie = "movie000001", Actor = "NVA1, NVA2, NVA3,...", Director = "NVD1", Description = "Noi dung phim 1", Category = "The loai 1, The loai 2", Duration = new TimeSpan(2, 30, 20), Rate = 5.0},
                new Movie{IdMovie = "movie000002", Actor = "NVA1, NVA2, NVA4,...", Director = "NVD2", Description = "Noi dung phim 2", Category = "The loai 4, The loai 2", Duration = new TimeSpan(3, 30, 20), Rate = 5.0},
                new Movie{IdMovie = "movie000003", Actor = "NVA1, NVA3, NVA5,...", Director = "NVD3", Description = "Noi dung phim 3", Category = "The loai 5", Duration = new TimeSpan(2, 10, 20), Rate = 5.0},
                new Movie{IdMovie = "movie000004", Actor = "NVA1, NVA4, NVA9,...", Director = "NVD1", Description = "Noi dung phim 4", Category = "The loai 1, The loai 3", Duration = new TimeSpan(1, 30, 20), Rate = 5.0},
                new Movie{IdMovie = "movie000005", Actor = "NVA3, NVA2, NVA10,...", Director = "NVD1", Description = "Noi dung phim 5", Category = "The loai 1, The loai 2", Duration = new TimeSpan(4, 30, 20), Rate = 5.0},

            });
            context.Rooms.AddRange(new[]
            {
                new Room{IdRoom = "room01", NameRoom = "Rap 1", NumberSeats = 100},
                new Room{IdRoom = "room02", NameRoom = "Rap 2", NumberSeats = 100},
                new Room{IdRoom = "room03", NameRoom = "Rap 3", NumberSeats = 100},
                new Room{IdRoom = "room04", NameRoom = "Rap 4", NumberSeats = 100},
                new Room{IdRoom = "room05", NameRoom = "Rap 5", NumberSeats = 100},
            });
